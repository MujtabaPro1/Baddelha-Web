  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      if (response.data && response.data.length > 0) {
        ...
        const processedAppointments = sortedAppointments.map((apt: any) => {
      ...
      {showModal && selectedAppointment && (
        <div className="fixed inset-0 overflow-y-auto z-50">
          <div className="flex items-end sm:items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-t-lg sm:rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-gray-50 p-3 rounded-md">
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="col-span-2">
                          ...
                          <p className="text-sm font-medium text-gray-900">
                            {selectedAppointment.car?.plateNumber}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-md">
                    <div className="flex justify-between items-center">
                      <h4 className="text-sm font-medium text-gray-700">Check-in Status</h4>
