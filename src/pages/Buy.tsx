    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="text-right">
            <div className="font-bold text-lg text-[#3d3d40]">
              SAR {car.price.toLocaleString()}
            </div>
            {car.originalPrice && (
            ...
            <div className="text-xs text-gray-600">Est. SAR 2,500/mo</div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          ...
          {car.features.length > 2 && (
            <span className="text-gray-500 text-xs">+{car.features.length - 2}</span>
          )}
        </div>
        ...
        <div className="flex gap-2">
          <button className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-3 rounded-lg transition text-sm">
            View Details
          </button>
          <button className="flex-1 bg-[#f78f37] hover:bg-[#e67d26] text-white py-2 px-3 rounded-lg transition text-sm">
            Contact
          </button>
        </div>
      </div>
