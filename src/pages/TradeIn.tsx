...
const TradeIn: React.FC = () => {
  ...
  const dealerships: Dealership[] = [
    ...
    },
    {
      ...
      address: 'Prince Mohammed Bin Abdulaziz, Riyadh 12244',
      ...
      specialties: ['Japanese Cars', 'Hybrid Vehicles', 'Commercial Fleet'],
      tradeInBonus: 4200,
  ...
  const calculateEstimatedValue = (vehicle: Vehicle) => {
    ...
    return Math.max(0, (baseValue - yearFactor - mileageFactor) * conditionMultiplier);
  };
